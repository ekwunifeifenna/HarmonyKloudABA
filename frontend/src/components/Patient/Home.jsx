...
function Home() {
    ...
    const handleNewsletter = async(e) =>{
        e.preventDefault(); 
        await axios.post("/admin/new-letter", {email})
        .then(() =>{
            Swal.fire({
                title: "Success",
                icon: "success",
        ...
        >
            ...
            className='flex flex-col lg:flex-row h-screen w-screen justify-center items-center max-w-7xl m-auto'>
                ...
                className='flex flex-col justify-center'> 
                    <p className='text-3xl font-semibold text-center'>What We Do </p> 
                    <p className='text-lg text-center'>The HarmonyKloud project aims to develop a comprehensive Software-as-a-
                        Service (SaaS) solution for managing autism practices. This solution will address
                        both clinical and practice management aspects, providing a holistic approach to
                        autism care. By deploying HarmonyKloud, autism management businesses can
        ...
        className='w-full h-full flex flex-col justify-center items-center'>
                ...
                whileInView={{ opacity: 1 }}>
                            <div>
                                ...
                                <p className='text-sm'>Responsible for the design, development, and maintenance of the HarmonyKloud SaaS solution</p>
                            </div>
                        </motion.div>
                                <motion.div  
                                ref={ref}
                ...
                whileInView={{ opacity: 1 }}>
                            <div>
                                <div className='flex justify-start gap-2 items-center'>
                                    ...
                                    <p className='text-xl font-semibold'>Sales and Marketing</p>
                                </div>
                            </div>
                            <p className='text-sm'>Handles customer acquisition, retention, and overall brand management.</p>
                        </motion.div>
                    </div>
                ...
                whileInView={{ opacity: 1 }}>
                            <div>
                                ...
                                <p className='text-sm'>Provides support and assistance to customers, ensuring they can effectively use the HarmonyKloud solution</p>
                            </div>
                        </motion.div>
                                <motion.div  
                                ref={ref}
                ...
                whileInView={{ opacity: 1 }}>
                            <div>
                                <div className='flex justify-start  gap-2 items-center '>
                                    ...
                                    <p className='text-xl font-semibold'>Finance, HR, and Administration</p>
                                </div>
                                <p className='text-sm'>Manages the financial aspects of the organization, including budgeting, financial reporting, and administrative tasks. This unit also handles recruitment, employee relations, and talent development</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <div className=' max-w-7xl m-auto flex flex-col justify-center gap-8 items-center w-full h-full overflow-auto '>
                ...
                whileInView={{ opacity: 1 }}
                 className='flex flex-col justify-center items-center'>
                    ...
                    <p className='text-sm text-center'>HarmonyKlod is great and easy to use</p>
                </motion.div>
                <motion.div
                ref={ref}
                initial={{ opacity: 0}} 
                ...
                whileInView={{ opacity: 1 }}
                 className='flex items-center gap-4 '>
                    ...
                    <div className='flex flex-col items-start py-5 p-5 w-[450px] shadow-xl bg-[#E9EDC9] shadow-violet-400 rounded-lg'>
                        ...
                        <div>
                            <p className=''>I have used so many ABA software, but Harmony Kloud has proven to be one of the best out there</p>
                        </div>
                    </div>
                </motion.div>
            </div>
                ...
                whileInView={{ opacity: 1 }}
                 className="mx-auto max-w-7xl px-2 py-10 lg:px-0 z-10 ">
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                ...
                                Be sure to check out and subscribe to the newsletters of HarmonyKloud to stay updated about the developments in healthcare field.  
                                </p>
                                <div className="mt-4">
