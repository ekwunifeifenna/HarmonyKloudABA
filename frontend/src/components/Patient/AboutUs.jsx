  ...
  return (
      ...
      whileInView={{ opacity: 1 }}
       className='h-screen w-screen '>
        ...
        <div className='z-10 bottom-0 hidden lg:block lg:left-32 py-4 rounded-t-lg lg:w-[400px] text-center bg-[#FAEDCD] absolute '>
          <p className='font-semibold text-3xl'>About HarmonyKloud</p>
        </div>
      </motion.div>
    ...
    whileInView={{ opacity: 1 }}
     className='h-screen max-w-7xl flex flex-col m-auto justify-center text-justify gap-1'>
        ...
        <p className='text-lg'>HarmonyKloud operates with a lean and agile team structure. The organization is divided into key functional areas</p>
        <p className='text-lg hidden lg:block'>In addition to this,  We are committed to creating a positive impact on autism practices by providing a comprehensive, efficient, and user-friendly SaaS solution. Our core values revolve around empathy, innovation, and excellence, which guide our efforts in developing and refining our product offerings.</p>
      </motion.div>
    </section>
    {/* <section  
